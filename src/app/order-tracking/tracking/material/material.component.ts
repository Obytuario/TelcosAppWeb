...
import { DetailMaterialComponent } from './Dialogs-materials/detail-material/detail-material.component';
// declare const M: any;
interface Gender {
  id: string;
  value: string;
...
export class MaterialComponent extends UnsubscribeOnDestroyAdapter
implements OnInit {
  displayedColumns = [  
    //'idOrden',
    'numeroOrden',
