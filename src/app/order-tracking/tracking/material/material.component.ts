...
export class MaterialComponent implements OnInit {
  ...
  selectedRowMaterialData: selectRowMaterialInterface;  
  newUserImg = 'assets/images/user/user1.jpg';
  data = [];
  filteredData = [];
  editForm: UntypedFormGroup;
  editFormMat: UntypedFormGroup;
  ...
  constructor(
    ...
    this.editFormMat = this.fb.group({
      id: new UntypedFormControl(),      
  ...
  editRowMat(row, rowIndex, content) {
    this.modalService.open(content, { ariaLabelledBy: 'modal-basic-title' });
    this.editFormMat.setValue({
      id: '1019110',      
      material: 'CONECTOR I-STOP-42 REVERSE TEST TRTC',
      cantidad: '4'   
    });
    this.selectedRowMaterialData = row;
  }
  addRow(content) {
    this.modalService.open(content, { ariaLabelledBy: 'modal-basic-title' });
...
export interface selectRowMaterialInterface {
  id: String;
  material: String;
  cantidad: String;
}
