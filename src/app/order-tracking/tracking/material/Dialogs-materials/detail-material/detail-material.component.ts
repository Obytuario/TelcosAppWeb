...
import { DetailWorkOrderFollowequipment, DetailWorkOrderFollowMaterial, OrderTracking } from 'src/app/order-tracking/order-tracking.model';
import { OrderTrackingService } from 'src/app/order-tracking/order-tracking.service';
import { UnsubscribeOnDestroyAdapter } from 'src/app/shared/UnsubscribeOnDestroyAdapter';
import { DeleteEquipmentComponent } from '../../../equipment/Dialogs-equipment/delete-equipment/delete-equipment.component';
import { EditEquipmentComponent } from '../../../equipment/Dialogs-equipment/edit-equipment/edit-equipment.component';
...
@Component({
  ...
  styleUrls: ['./detail-material.component.sass']
})
export class DetailMaterialComponent extends UnsubscribeOnDestroyAdapter implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<DetailMaterialComponent>,
...
export class ExampleDataSource extends DataSource<DetailWorkOrderFollowMaterial> {
  ...
  filteredData: DetailWorkOrderFollowMaterial[] = [];
  renderedData: DetailWorkOrderFollowMaterial[] = [];
  constructor(
  ...
  connect(): Observable<DetailWorkOrderFollowMaterial[]> {
    // Listen for any changes in the base data, sorting, filtering, or pagination
    const displayDataChanges = [
      this.exampleDatabase.dataChangeMaterial,
      //this._sort.sortChange,
      this.filterChange
      //this.paginator.page
    ];
    this.exampleDatabase.getDetailOrderMaterialTables(this.order);
    return merge(...displayDataChanges).pipe(
      map(() => {
        // Filter data
        this.renderedData = this.exampleDatabase.dataDetailMaterial
          .slice()
          .filter((detailEquipmentTable: DetailWorkOrderFollowMaterial) => {
            const searchStr = (
              detailEquipmentTable.codigoMaterial+
              detailEquipmentTable.nombreMaterial                
